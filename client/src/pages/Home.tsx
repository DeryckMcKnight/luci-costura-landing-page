    ...
    <div className="min-h-screen bg-white text-foreground">
            ...
            <AnimatedSection animation="fade-in-right">
              <div className="relative">
                <img
                  ...
                  className="w-full h-auto rounded-lg image-hover image-fade-in"
                />
              </div>
            </AnimatedSection>
          </div>
        ...
        <section id="sobre" className="py-24 bg-white">
          <div className="container">
            <div className="max-w-3xl">
              <h2 className="font-display-bold text-4xl mb-8 text-foreground title-fade-in">
                Sobre Lucimar
              </h2>
      ...
      <AnimatedSection animation="fade-in">
        <section id="formacao" className="py-24 bg-white">
          <div className="container">
            <h2 className="font-display-bold text-4xl mb-16 text-foreground title-fade-in">
              Formação Profissional
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              {/* Costureira */}
              <div className="card-subtle p-8 card-fade-in delay-100">
                <h3 className="font-display text-2xl mb-6 text-foreground">
                  Curso de Costureira
                </h3>
                <ul className="space-y-4 text-muted-foreground">
                  <li className="flex gap-3 list-item-fade-in delay-100">
                  ...
                  <li className="flex gap-3 list-item-fade-in delay-200">
                    <span className="text-primary font-bold">•</span>
                    <span>
                      Corte e montagem de peças do vestuário com precisão
                    </span>
                  </li>
                  <li className="flex gap-3 list-item-fade-in delay-300">
                    <span className="text-primary font-bold">•</span>
                    <span>
                      Técnicas profissionais para diferentes tipos de tecidos
                    </span>
                  </li>
                  <li className="flex gap-3 list-item-fade-in delay-400">
                    <span className="text-primary font-bold">•</span>
              ...
              {/* Modelista */}
              <div className="card-subtle p-8 card-fade-in delay-200">
                <h3 className="font-display text-2xl mb-6 text-foreground">
                  Curso de Modelista
                </h3>
                <ul className="space-y-4 text-muted-foreground">
        ...
        <section id="servicos" className="py-24 bg-white">
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              {/* Ajustes e Reformas */}
              <div className="card-subtle p-8 card-fade-in delay-300">
                <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-6">
        ...
        <section className="py-24 bg-white">
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl">
              <div className="flex gap-4 card-fade-in delay-100">
              ...
              <div className="flex gap-4 card-fade-in delay-200">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center h-8 w-8 rounded-full bg-primary/10">
                    <span className="text-primary font-bold">✓</span>
                  </div>
              ...
              <div className="flex gap-4 card-fade-in delay-300">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center h-8 w-8 rounded-full bg-primary/10">
                    <span className="text-primary font-bold">✓</span>
                  </div>
              ...
              <div className="flex gap-4 card-fade-in delay-400">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center h-8 w-8 rounded-full bg-primary/10">
                    <span className="text-primary font-bold">✓</span>
                  </div>
        ...
        <section id="contato" className="py-24 bg-white">
          <div className="container">
            <div className="max-w-2xl mx-auto text-center">
              <h2 className="font-display-bold text-4xl mb-6 text-foreground title-fade-in">
